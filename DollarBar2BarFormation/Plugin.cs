...
namespace DollarBar2BarFormation
{
	...
	public partial class PluginSettingsPanel : Form
	{
		...
		public PluginSettingsPanel(IParams _params)
		{
			...
			if (_params != null)
			{
				...
				object val3 = null;
				_params.GetValue((int)EFields.Barsizefix,out val3);
		...
		{
			int thday = 0;
			if (IsValidThreshold(ThresholdDays.Text, out thday))
			{
				if (m_params != null)
		...
		{
			int barsizefix = 0;
			if (IsValidBarSizeFix(BarsizeFix.Text, out barsizefix))
			{
				if (m_params != null)
    ...
    partial class PluginSettingsPanel
	{
		...
		private void InitializeComponent()
		{
			...
			this.LabelThreshold.Location = new System.Drawing.Point(16, 50);
